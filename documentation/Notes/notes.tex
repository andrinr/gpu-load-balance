...
\begin{filecontents*}{particles9.csv}
x,y,id,o1,o2
0.4,0.3,0,0,0
0.2,0.6,1,2,1
0.8,0.9,2,1,2
...
\begin{figure}[H]
    \begin{center}
        ...
        \csvreader[
            ...
            ]{particles6.csv}{}{\csvcoli & \csvcolii & \csvcoliii}
        \end{minipage}
...
In the case of global reshuffling, we reshuffle the particle in such a way, that we can designate a new operator for the second half of the particles, each time we perform a split. When looking at the numeric example this might look as follows:
...
Describe our analysis weather it makes sense to use streams and why.
