...
\begin{enumerate}
	...
	\item \textbf{Shared Memory bank conflicts} \TODO{do}
	\item \textbf{Warp divergence}  \TODO{do} 
\end{enumerate}
...
\subsubsection{CUDA GPU Tree Building}

In section \ref{gpu-tree-building} we have mentioned how Cuda GPU Tree building can improve runtime by reducing the data transfers between the CPU and GPU. However this is only effective when combined with a GPU sorting algorithm.
