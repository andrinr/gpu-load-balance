...
\begin{filecontents*}{particles4.csv}
x,y,id
0.4,0.3,0
0.2,0.6,1
0.8,0.9,2
...
\begin{figure}[H]
    \begin{center}
        ...
        \csvreader[
            ...
            ]{particles4.csv}{}{\csvlinetotablerow}
        \end{minipage}
...
We also performed some testing on CPU with AVX2 enabled. We summed up $2^{26}$ particles. 
The version with AVX enabled took 0.25 seconds, meanwhile the non AVX version took 1.2 seconds. This yields in a speed improvement of almost a factor of 6, which is not to expect considering some overhead. 
