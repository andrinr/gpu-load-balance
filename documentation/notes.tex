...
We choose a column major storage order, over a row major storage order, enabling accessing each axis i.e. $x_{axis,:}$ as a single array. This increases performance due to coalesced memory access. 
