...
\newcommand{\block}[3]{
	...
	\node[anchor=center] at (#1 cm, #2 -2.25 cm) {$Shared Memory$};
}
...
\begin{figure}[H]
	\begin{center}
		\begin{tikzpicture}
			...
			minimum height = 9cm] (cpu1) at (3.75 cm, -1cm) {};
			\node[anchor=center] at (3.75 cm, -4 cm) {$Global Memory$};
			...
			\node[anchor=west] at (3.75 cm, -4 cm) {$Global Memory$};
