...
If we subtract the time lost for the partitioning, the GPU version is about $5.6$ times faster, which is very close to the $5.25$ which were expected in the theoretical model. The total runtime is not equal to the one expected, however the theoretical model works with upper bound runtimes for the bisection method, in the method terminates at around 20 iterations. When scaling the theoretical model with this, the results look a lot closer.
