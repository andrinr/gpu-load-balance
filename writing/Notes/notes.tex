...
For our case we refrain from using approximation algorithms. In theory this would be possible, but we would get similar issues as described in described in \ref{sec:balancing}. Since we cannot make any assumpotions 
...
\TODO{Add runtime, Hoar Partitioning}
...
\begin{figure}
	\begin{center}
		\begin{tikzpicture}
			...
			\draw [-stealth](\ox,13) -- (\ox,0);
			\node[yshift=0.5cm] at (\ox,13) {Operative};
			\draw [-stealth](\wxa,13) -- (\wxa,0);
			\node[yshift=0.5cm] at (\wxa,13) {Worker A};
			\draw [-stealth](\wxb,13) -- (\wxb,0);
			\node[yshift=0.5cm] at (\wxb,13) {Worker B};
			
			\draw [dashed](\ox cm - 1cm ,\ta cm + 0.5cm) -- (\wxb cm + 1cm,\ta cm + 0.5cm);
			\node[xshift=-0.3cm] at (\ox cm - 1cm, \ta cm + 0.5cm) {$t_0$};
		
			\draw [dashed](\ox cm - 1cm ,\tl cm - 0.5cm) -- (\wxb cm + 1cm,\tl cm - 0.5cm);
			\node[xshift=-0.3cm] at (\ox cm - 1cm, \tl cm - 0.5cm) {$t_n$};
		
			%\draw [dashed, -stealth](\ox cm - 1cm ,\ti cm - 0.5cm) -- (\ox cm - 1cm ,\tb cm + 0.5cm);
			\draw [line width=0.5mm](\ox cm - 1cm ,\ti cm - 0.5cm) -- (\wxb cm + 1cm,\ti cm - 0.5cm);
			\draw [line width=0.5mm, -{stealth[scale=4]}](\ox cm - 1cm ,\ti cm - 0.5cm) -- (\ox cm - 1cm ,\ta cm - 0.5cm);
			\draw [line width=0.5mm](\ox cm - 1cm ,\ta cm - 0.5cm) -- (\wxb cm + 1cm,\ta cm - 0.5cm);
			\draw [line width=0.5mm](\wxb cm + 1cm,\ti cm - 0.5cm) -- (\wxb cm + 1cm,\ta cm - 0.5cm);
			\node[xshift=0.3cm,  rotate=-90] at (\wxb cm + 1cm,\te cm - 0.5cm) {loop till correct split};
			...
			anchor = west,
			fill = white,
			minimum width = \wxb cm, 
			minimum height = 0.5cm] (r) at (\ox,\ta) {Broadcast Cells};
			...
			rotate=-90,
			minimum width = 2 cm, 
			minimum height = 0.5cm] (r) at (\ox,\tb) {compute\\ split};
			...
			fill = white,
			minimum width = \wxb cm, 
			minimum height = 0.5cm] (r) at (\ox,\te) {Broadcast Cut};
			...
			rotate=-90,
			minimum width = 2 cm, 
			minimum height = 0.5cm] (r) at (\ox,\tf) {count};
			...
			rotate=-90,
			minimum width = 2 cm, 
			minimum height = 0.5cm] (r) at (\wxa,\tf) {count};
			...
			rotate=-90,
			minimum width = 2 cm, 
			minimum height = 0.5cm] (r) at (\wxb,\tf) {count};
			...
			fill = white,
			minimum width = \wxb cm, 
			minimum height = 0.5cm] (r) at (\ox,\ti) {Reduce Count};
			...
			rotate=-90,
			minimum width = 2 cm, 
			minimum height = 0.5cm] (r) at (\ox,\tj) {generate\\ new \\ cells};
