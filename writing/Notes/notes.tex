...
\begin{figure}
	\begin{center}
		\begin{tikzpicture}
			...
			\communication{Broadcast cells}{7}{15};
			...
			\communication{Broadcast cut from operative}{7}{8};
			...
			\communication{Reduce count to operative}{7}{4};
...
\begin{figure}
	\begin{center}
		\begin{tikzpicture}
			...
			\parallelloop{-1.25}{15.75}{3}{0.5}{loop till all cells found};
			
			\parallelloop{-1}{11.5}{2.75}{3.25}{loop till cut found};
			
			\communication{Broadcast \\ cells}{3}{15};
			
			\process{global\\ reshuffle}{0}{14};
			\process{global\\ reshuffle}{2}{14};
			\process{global\\ reshuffle}{4}{14};
			\process{global\\ reshuffle}{6}{14};
			
			\process{compute\\ cut}{0}{11};
			
			
			\communication{Broadcast cut \\ from operative}{3}{8};
			...
			\communication{Reduce count \\ to operative}{3}{4};
