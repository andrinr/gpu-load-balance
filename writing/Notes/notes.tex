...
\begin{itemize}
	\item \textbf{particles}: The cell class has ownership over the particles array.
	\item \textbf{cellToParticles}: This array maps from a $cell.id$ to a tuple with entries $a$ and $b$ where a marks the index of the first particle in the particles array which is contained in this cell. Consequently $b$ marks the index after the last particle contained in the volume of the cell. Note that this is possible due to the constant reshuffling.
