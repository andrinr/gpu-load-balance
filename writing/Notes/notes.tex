...
\begin{figure}
	\begin{center}
		\begin{tikzpicture}
			...
			\communication{Broadcast cells}{6}{15};
						
			\process{local\\ reshuffle}{0}{14};
			\process{local\\ reshuffle}{3}{14};
			\process{local\\ reshuffle}{6}{14};
			
			\process{compute\\ cut}{0}{11};
			
			 
			\communication{Broadcast cut from operative}{6}{8};
			...
			\communication{Reduce count to operative}{6}{4};
